...
import dev.joven.lib12.TwelvethGlobalCFG;


public class TwelvethScrLoad extends AppCompatActivity {
    mgdUtil tools;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twelveth_scr_load);
        tools = TwelvethGlobalCFG.getTools(this);
        ...
        splashUI.createSplashUI(this, TwelvethContent.class, R.raw.loading);
    }
}